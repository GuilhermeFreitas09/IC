...
```{r estruturaCelular, echo=FALSE, fig.cap="A figura à esquerda é uma célula animal (eucarionte). A figura à direita representa uma célula eucarionte", fig.pos="h", out.width = '100%'}
