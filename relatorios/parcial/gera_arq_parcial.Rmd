...
```
```{r}
saveRDS(matriz_betas, file = "../../data/matriz_betas.rds")
```

```{r}
saveRDS(minfi::getM(mSetSq), file = "../../data/matriz_m.rds")
```

```{r}
matriz_betas <- readRDS("../../data/matriz_betas.rds")
```
...
## Clustering baseados em partições
